...
table.insert(xml, [[<action application="avmd_start" data= "detection_mode=1,inbound_channel=1,outbound_channel=1"/>]])
...
table.insert(xml, [[<action application="lua" data="avmd.lua"/>]]);
